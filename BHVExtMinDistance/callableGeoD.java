...
public class callableGeoD implements Callable<geodesicDistance> {
    private treePair Tpair;
    
    public callableGeoD(treePair TreePair){
        this.Tpair = TreePair;
    }
    
    
    public geodesicDistance call() {
        geodesicDistance TempResult = new geodesicDistance(this.Tpair);
        return TempResult;
    }
}